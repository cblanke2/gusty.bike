...
section "Installing system packages..."
    ...
    apt install $REPO_DIR/Scripts/oracle-java8-installer_8u201-1~webupd8~1_all.deb
    apt install $REPO_DIR/Scripts/oracle-java8-set-default_8u201-1~webupd8~1_all.deb
